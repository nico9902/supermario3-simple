...
class Entity : public Object
{
    protected:
		...
		bool phantom;						// no collisions with other entities
    ...
    public:
		...
		virtual void setFalling(bool _falling) { falling = _falling; }
		virtual void setWalkableObject(Inert* _walkable) { walkable_object = _walkable; }
